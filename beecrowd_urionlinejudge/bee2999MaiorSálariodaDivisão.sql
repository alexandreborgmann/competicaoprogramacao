...
SELECT 
    s.nome,
    ROUND(s.salario::numeric, 2) as salario
FROM salario_liquido s
JOIN medias_por_divisao md ON s.lotacao_div = md.cod_divisao
WHERE s.salario >= 8000.00 
  AND s.salario > md.media_salarial

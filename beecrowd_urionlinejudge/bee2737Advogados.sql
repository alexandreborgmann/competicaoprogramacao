...
select x.name, x.customers_number
from (
select l.name, l.customers_number, 1 ordem
from lawyers l
where customers_number=(
select max(l1.customers_number)
from lawyers l1
)
union
select l.name, l.customers_number, 2 ordem
from lawyers l
where customers_number=(
select min(l1.customers_number)
from lawyers l1
)
union
SELECT 

...
Task:
If you know how many of each color block you have, add up the leftover blocks to come up with the amount you will have after you
have evenly distributed each color to all 15 students.
...
print(azul%15+vermelho%15+verde%15+amarelo%15)
